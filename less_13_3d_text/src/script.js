...
import {
    ...
    Mesh,
    TextureLoader,
    BoxGeometry, AxesHelper, MeshMatcapMaterial, TorusGeometry
} from 'three';
...
fontLoader.load(
    ...
    (font) => {
        ...
        const textMaterial = new MeshMatcapMaterial({matcap: textTexture});
        const text = new Mesh(textGeometry, textMaterial);
        scene.add(text);

        const donutGeometry = new TorusGeometry(0.3, 0.2, 20, 45);
        const donutMaterial = new MeshMatcapMaterial({matcap: donutTexture});
